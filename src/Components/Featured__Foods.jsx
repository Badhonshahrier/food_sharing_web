...
const Featured__Foods = () => {
  ...
  return (
    <div className="w-10/11 mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-10 px-6 pb-20">
        {foods.map((food, index) => (
          <div key={index} className="">
            <div className="card bg-base-100 shadow-xl image-full duration-300 hover:scale-105 h-[300px]">
              ...
              <div className="card-body flex flex-col justify-between text-white p-4">
