...
const Banner = () => {
  const photos = [
    "https://i.ibb.co/rG2Cc7H4/food-sharing-project-vector-illustration-260nw-1638500074.jpg",
    "https://i.ibb.co.com/wrF4J0Nh/images.png",
    "https://i.ibb.co.com/rR12tysB/images.jpg",
  ];
  return (
      ...
      <div className="hero-content flex-col-reverse lg:flex-row gap-10">
        ...
        <div className="max-w-xl ml-2 text-center lg:text-left">
          ...
          <p className="mb-8 text-lg text-gray-600">
            At the heart of every community is the joy of sharing. A small act
            of kindness — like offering extra food — can brighten someone’s
            entire day.
          </p>
          <Link to="/addfood">
